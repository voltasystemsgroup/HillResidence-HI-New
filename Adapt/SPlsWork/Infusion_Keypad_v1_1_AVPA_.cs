...
namespace UserModule_INFUSION_KEYPAD_V1_1_AVPA_
{
    public class UserModuleClass_INFUSION_KEYPAD_V1_1_AVPA_ : SplusObject
    {
...
object VANTAGE_RX__DOLLAR___OnChange_2 ( Object __EventInfo__ )
    ...
    try
    {
        ...
        TEMPSTR__DOLLAR__  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 70, this );
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        ushort __FN_FORSTART_VAL__1 = (ushort) ( 96 ) ;
...
public override void LogosSplusInitialize()
{
    ...
    BUTTON = new InOutArray<DigitalInput>( 96, this );
    for( uint i = 0; i < 96; i++ )
    {
    ...
    BUTTON_FB = new InOutArray<DigitalOutput>( 96, this );
    for( uint i = 0; i < 96; i++ )
    {
    ...
    BUTTON_STATE_FB = new InOutArray<AnalogOutput>( 96, this );
    for( uint i = 0; i < 96; i++ )
    {
    ...
    BUTTON_LED_BLINK_FB = new InOutArray<AnalogOutput>( 96, this );
    for( uint i = 0; i < 96; i++ )
    {
    ...
    VANTAGE_RX__DOLLAR__ = new Crestron.Logos.SplusObjects.StringInput( VANTAGE_RX__DOLLAR____AnalogSerialInput__, 70, this );
    m_StringInputList.Add( VANTAGE_RX__DOLLAR____AnalogSerialInput__, VANTAGE_RX__DOLLAR__ );
    
    VID_INPUT__DOLLAR__ = new InOutArray<StringInput>( 96, this );
    for( uint i = 0; i < 96; i++ )
    {
...
public UserModuleClass_INFUSION_KEYPAD_V1_1_AVPA_ ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint BUTTON_LED_BLINK_FB__AnalogSerialOutput__ = 97;
